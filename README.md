...
So, I've decided to stop trying to speed-run through complex projects that will only further establish that shaky foundation, and instead take on smaller projects that would allow me to be more <em>intentional</em> with my code.
